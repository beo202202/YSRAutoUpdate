...
//일시중지 또는 정지 버튼
// 다시로드에 환경설정 함수를 넣어야할 듯....

// 언에이블 기능....

// 현재최소값이 설정최소값보다 작으면 오류...

// 설정창을 닫으면 다시 로드해야함.... 오류 현재값이 설정값보다 크거나 작은 경우 콤보박스 설정해야함.


// 환경설정 다 불러오기 전에는 닫기, 콤보박스 등 모두 언에이블

// 환경설정() => 저장된 자료를 이용해서 불러오기
// 폼의 컬렉션을 제거하면 화면이 안뜸.
// 아이템 컬렉션 추가, 삭제, 삽입 잘 구분해야할 듯.
